...
class CheemsRootCommandsCog(commands.Cog, name='Root'):
    ...
    async def help(self, ctx):
        self.embed = discord.Embed(title="Cheems advanced technologies",
                                   description="Official help sheet",
                                   color=0x00ff7b)
        self.embed.set_author(name="Cheemsburguer help",
                              icon_url="https://cdn140.picsart.com/314611123258211.png?type=webp&to=min&r=480")
        self.embed.add_field(name="4chan",
                             value="tech",
                             inline=False)
        self.embed.add_field(name="Fun with cheemsburguer",
                             value="ask, bf, femboy, gf, ischad, neko, owofy",
                             inline=False)
        self.embed.add_field(name="NSFW",
                             value="lewdfemboy, lewdneko",
                             inline=True)
        self.embed.add_field(name="Neko Actions",
                             value="cuddle, kiss, pat, slap",
                             inline=True)
        self.embed.add_field(name="Reddit",
